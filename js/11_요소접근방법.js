...
function classTest(){
    ...
    // class 속성 값이 "cls-test"인 요소를 모두 얻어와 (유사)배열 형태로 반환
...
function classTest2(){
    ...
    for(let i=0; i < inputs.length; i++){
        ...
        // 각 요소(input)에 작성된 값을 얻어와 number 타입으로 변환하여 sum에 누적
...
function tagNameTest(){
    ...
    for(let i=0; i<lists.length; i++){
        ...
        lists[i].style.backgroundColor = `rgb(200, 0, ${20 * num})`;
    }
