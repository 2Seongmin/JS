...
/* 
    ...
    html 요소에 작성된 내용 : html.innerText
*/
...
function check5(){
    ...
    if( Number(input5.value) === 3 ){
        ...
        result2 = "3,4,5 가 아닌 다른 숫자가 입력되었습니다.";
    }
    alert(result2);
...
function calc(op){
    ...
    // 전달 받은 매개변수(op) 값에 따라 서로 다른 연산 수행
    switch(op){
        // 전달 받은 매개변수가 '+' 
...
function check6(){
    ...
    // break(멈추다) : 현재 case 까지만 switch 문을 멈춤

    // -> break 미작성시, 현재 case 수행 후 멈추지 않고 다음 case를 연달아 수행
